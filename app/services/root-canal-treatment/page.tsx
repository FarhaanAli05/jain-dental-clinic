...
export const metadata: Metadata = {
  ...
  description:
    "Save your natural tooth and relieve discomfort with gentle, effective root canal therapy at Jain Dental Clinic.",
  openGraph: {
    title: "Root Canal Treatment | Jain Dental Clinic",
    description:
      "Modern root canal therapy to relieve pain and restore your smile in Brampton and Vaughan.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Root Canal Treatment | Jain Dental Clinic",
    description:
      "Gentle, effective root canal treatment using modern techniques for lasting relief.",
      ...
      <Container className="mb-20">
        <div className="mt-20 flex flex-col gap-x-13 xl:flex-row">
          ...
          <div>
            ...
            <h1 className="ml-2">
              Expert Root Canal Therapy For Lasting Comfort
            </h1>
            {/* <div className="bg-[#CAFAFF] w-123 h-7 mt-[-33]" /> */}
            <p className="mt-10">
              A root canal doesn’t have to be intimidating—it’s a safe and
              effective way to save your natural tooth while eliminating
              infection and pain. At Jain Dental Clinic, our experienced team
              uses gentle techniques and modern technology to make the procedure
              as comfortable as possible.
              <br />
              <br />
              By removing infected tissue and sealing the tooth, root canal
              treatment helps preserve your natural bite, prevents further
              complications, and restores your smile’s strength and function.
              Whether you’re experiencing tooth pain, sensitivity, or swelling,
              our priority is to get you relief and protect your long-term oral
              health.
            </p>
          </div>
        </div>
