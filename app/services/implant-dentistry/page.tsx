...
export const metadata: Metadata = {
  ...
  description:
    "Restore missing teeth with durable, natural-looking dental implants at Jain Dental Clinic.",
  openGraph: {
    title: "Implant Dentistry | Jain Dental Clinic",
    description:
      "Permanent tooth replacement with advanced dental implants in Brampton and Vaughan.",
    images: [
      {
      ...
      <Container className="mb-20">
        <div className="mt-20 flex flex-col gap-x-13 xl:flex-row">
          ...
          <div>
            ...
            <p className="mt-10">
              Missing teeth can affect more than just your smile—they can impact
              your ability to chew, speak, and feel confident. At Jain Dental
              Clinic, we provide advanced implant dentistry to restore both the
              function and appearance of your natural teeth.
              <br />
              <br />
              Dental implants are a permanent, durable solution that looks and
              feels just like your own teeth. Whether you need to replace a
              single tooth or multiple teeth, our experienced team will design a
              personalized treatment plan to bring back your smile’s strength,
              stability, and beauty. With modern techniques and compassionate
              care, we make the process as comfortable and stress-free as
              possible.
            </p>
          </div>
        </div>
