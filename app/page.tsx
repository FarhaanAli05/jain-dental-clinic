  ...
  return (
    <div>
      <div>
        ...
        <div>
          ...
          <nav>
            <ul>
              ...
              <li><Link href="/">Our Clinic</Link></li>
        ...
        <h1>Personalized, professional care by experienced dentists</h1>
      ...
      <div>
        <div>
          ...
          <h1>Welcome to Jain Dental Clinic!</h1>
          <p>
            At Jain Dental Clinic, we treat every patient like part of our extended family—offering honest guidance, expert treatment, and a welcoming atmosphere from the moment you walk in.
      ...
      <div>
        <Image
          src={"/images/home-services-background.png"}
          width={100}
          height={100}
          alt=""
          aria-hidden="true"
      ...
      <div>
        ...
        <h1>A Look Inside Jain Dental</h1>
